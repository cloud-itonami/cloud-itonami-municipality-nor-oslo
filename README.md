# cloud-itonami-municipality-nor-oslo
...
actuation actor. It proposes or executes nothing on the City of Oslo's
behalf.
...
Both entries cite official [oslo.kommune.no](https://www.oslo.kommune.no/)
pages, which rendered fully: the **Reglement for bystyret** (Rules of
Procedure for the City Council, approved 2023-08-30, effective
2023-10-25) and the **Forskrift om serverings-, salgs- og
skjenkebevillinger i Oslo kommune** (serving/sales/liquor-licensing
hours regulation, approved 2025-04-30).
...
festivals and heritage sites for Oslo:
...
itself remains the City of Oslo's; this repo stores only citation
